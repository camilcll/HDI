...
function changementType() {
                ...
                if (type == "cours" ){
					document.getElementById("date-cours").style.display="block";
					document.getElementById("country-cours").style.display="block";
					document.getElementById("lectureType-element").style.display="block";
				}else{
					document.getElementById("date-cours").style.display="none";
					document.getElementById("country-cours").style.display="none";
					document.getElementById("lectureType-element").style.display="none";
				}
                if (type == "image") {
					document.getElementById("keyword-image-element").style.display="block";
                    document.getElementById("licence-image-element").style.display="block";
                    document.getElementById("imageType-element").style.display="block";
                    document.getElementById("date-prise-image").style.display="block";
                    document.getElementById("circa-element").style.display="block";
                    document.getElementById("country-image").style.display="block";
                    document.getElementById("watermark-element").style.display="block";
				} else{
					document.getElementById("keyword-image-element").style.display="none";
                    document.getElementById("licence-image-element").style.display="none";
                    document.getElementById("imageType-element").style.display="none";
                    document.getElementById("date-prise-image").style.display="none";
                    document.getElementById("circa-element").style.display="none";
                    document.getElementById("country-image").style.display="none";
                    document.getElementById("watermark-element").style.display="none";
				}
                if (type == "video" ){
                    document.getElementById("licence-element").style.display="block";
                    document.getElementById("date-enregistrement").style.display="block";
				}else{
                    document.getElementById("licence-element").style.display="none";
                    document.getElementById("date-enregistrement").style.display="none";
				}

				if (type == "son" ){
                    document.getElementById("licence-son").style.display="block";
                    document.getElementById("date-enregistrement-son").style.display="block";
				}else{
                    document.getElementById("licence-son").style.display="none";
                    document.getElementById("date-enregistrement-son").style.display="none";
				}
				if (type == "carte" ){
                    document.getElementById("licence-carte").style.display="block";
                    document.getElementById("date-creation").style.display="block";
                    document.getElementById("country-carte").style.display="block";
				}else{
                    document.getElementById("licence-carte").style.display="none";
                    document.getElementById("date-creation").style.display="none";
                    document.getElementById("country-carte").style.display="none";
                }
                if (type == "logiciel" ){
					document.getElementById("licence-logiciel").style.display="block";
				}else{
					document.getElementById("licence-logiciel").style.display="none";
				}
