...
define('MENU_INSCRIPTION', "S'inscrire");
define('MENU_DECONNEXION', 'Deconnexion');
define('MENU_VIP', 'VIP');
define('MENU_AJOUTVIP', 'Ajouter un VIP');
define('MENU_ECHANGE','Echanges effectués');
define('INFOS_PHOTO','Details CRM');
...
define('AJOUT_OK',"L'utilisateur a bien été ajouté");
