        ...
        <div id="panel_domain" style="margin-bottom:10px;"> 
            ...
            <ul class="tree">
                <li style="display : list-item;">
                    ...
                    <span class="libelle click" style="cursor: pointer;">Chimie</span>
                        <ul>
                ...
                <span class="libelle click" style="cursor: pointer;">Informatique [cs]</span>
                    <ul style="height: 0px; opacity: 0;">
                ...
                <span class="libelle click" style="cursor: pointer;">Mathématiques [math]</span>
                    <ul>
                ...
                <li style="display : list-item;">
                <input id="nlin" style="display: none;" type="checkbox" value="nlin"><label style="margin-bottom: 2px; margin-right: 5px;" for="nlin"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Science non linéaire [physics]</span>
                    <ul>
                ...
                <span class="libelle click" style="cursor: pointer;">Physique [physics]</span>
                    <ul>
                        <li style="display : list-item;"><input id="phys.astr" style="display: none;" type="checkbox" value="phys.astr"><label style="margin-bottom: 2px; margin-right: 5px;" for="phys.astr"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Astrophysique [astro-ph]</span>
                            <ul>
                        ...
                        <li style="display : list-item;"><input id="phys.cond" style="display: none;" type="checkbox" value="phys.cond"><label style="margin-bottom: 2px; margin-right: 5px;" for="phys.cond"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Matière Condensée [cond-mat]</span>
                            <ul>
                                ...
                                <li style="display : list-item;"><input id="phys.meca" style="display: none;" type="checkbox" value="phys.meca"><label style="margin-bottom: 2px; margin-right: 5px;" for="phys.meca"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Mécanique [physics]</span>
                                    <ul>    
                                ...
                                <li style="display : list-item;"><input id="phys.phys" style="display: none;" type="checkbox" value="phys.phys"><label style="margin-bottom: 2px; margin-right: 5px;" for="phys.phys"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Physique [physics]</span>
                                    <ul>
                        ...
                        <li style="display : list-item;"><input id="scco" style="display: none;" type="checkbox" value="scco"><label style="margin-bottom: 2px; margin-right: 5px;" for="scco"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Sciences cognitives</span>
                            <ul>
                        ...
                        <li style="display : list-item;"><input id="sde" style="display: none;" type="checkbox" value="sde"><label style="margin-bottom: 2px; margin-right: 5px;" for="sde"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Sciences de l'environnement</span>
                            <ul>
                        ...
                        <li style="display : list-item;"><input id="sdu" style="display: none;" type="checkbox" value="sdu"><label style="margin-bottom: 2px; margin-right: 5px;" for="sdu"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Planète et Univers [physics]</span>
                            <ul>
                                <li style="display : list-item;"><input id="sdu.astr" style="display: none;" type="checkbox" value="sdu.astr"><label style="margin-bottom: 2px; margin-right: 5px;" for="sdu.astr"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Astrophysique [astro-ph]</span>
                                    <ul>
                                        ...
                                        <li style="display : list-item;"><input id="sdu.stu" style="display: none;" type="checkbox" value="sdu.stu"><label style="margin-bottom: 2px; margin-right: 5px;" for="sdu.stu"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Sciences de la Terre</span>
                                            <ul>
                                ...
                                <li style="display : list-item;"><input id="sdv" style="display: none;" type="checkbox" value="sdv"><label style="margin-bottom: 2px; margin-right: 5px;" for="sdv"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Sciences du Vivant [q-bio]</span>
                                    <ul>
                                        ...
                                        <li style="display : list-item;"><input id="sdv.ba" style="display: none;" type="checkbox" value="sdv.ba"><label style="margin-bottom: 2px; margin-right: 5px;" for="sdv.ba"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Biologie animale</span>
                                            <ul>
                                        ...
                                        <li style="display : list-item;"><input id="sdv.bbm" style="display: none;" type="checkbox" value="sdv.bbm"><label style="margin-bottom: 2px; margin-right: 5px;" for="sdv.bbm"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Biochimie, Biologie Moléculaire</span>
                                            <ul>
                                        ...
                                        <li style="display : list-item;"><input id="sdv.bc" style="display: none;" type="checkbox" value="sdv.bc"><label style="margin-bottom: 2px; margin-right: 5px;" for="sdv.bc"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Biologie cellulaire</span>
                                            <ul>
                                        ...
                                        <li style="display : list-item;"><input id="sdv.bdd" style="display: none;" type="checkbox" value="sdv.bdd"><label style="margin-bottom: 2px; margin-right: 5px;" for="sdv.bdd"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Biologie du développement</span>
                                            <ul>
                                        ...
                                        <li style="display : list-item;"><input id="sdv.bdlr" style="display: none;" type="checkbox" value="sdv.bdlr"><label style="margin-bottom: 2px; margin-right: 5px;" for="sdv.bdlr"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Biologie de la reproduction</span>
                                            <ul>
                                        ...
                                        <li style="display : list-item;"><input id="sdv.bid" style="display: none;" type="checkbox" value="sdv.bid"><label style="margin-bottom: 2px; margin-right: 5px;" for="sdv.bid"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Biodiversité</span>
                                            <ul>
                                        ...
                                        <li style="display : list-item;"><input id="sdv.bv" style="display: none;" type="checkbox" value="sdv.bv"><label style="margin-bottom: 2px; margin-right: 5px;" for="sdv.bv"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Biologie végétale</span>
                                            <ul>
                                        ...
                                        <li style="display : list-item;"><input id="sdv.ee" style="display: none;" type="checkbox" value="sdv.ee"><label style="margin-bottom: 2px; margin-right: 5px;" for="sdv.ee"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Ecologie, Environnement</span>
                                            <ul>
                                        ...
                                        <li style="display : list-item;"><input id="sdv.gen" style="display: none;" type="checkbox" value="sdv.gen"><label style="margin-bottom: 2px; margin-right: 5px;" for="sdv.gen"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Génétique</span>
                                            <ul>
                                        ...
                                        <li style="display : list-item;"><input id="sdv.ib" style="display: none;" type="checkbox" value="sdv.ib"><label style="margin-bottom: 2px; margin-right: 5px;" for="sdv.ib"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Ingénierie biomédicale</span>
                                            <ul>
                                        ...
                                        <li style="display : list-item;"><input id="sdv.imm" style="display: none;" type="checkbox" value="sdv.imm"><label style="margin-bottom: 2px; margin-right: 5px;" for="sdv.imm"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Immunologie</span>
                                            <ul>
                                        ...
                                        <li style="display : list-item;"><input id="sdv.mhep" style="display: none;" type="checkbox" value="sdv.mhep"><label style="margin-bottom: 2px; margin-right: 5px;" for="sdv.mhep"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Médecine humaine et pathologie</span>
                                            <ul>
                                        ...
                                        <li style="display : list-item;"><input id="sdv.mp" style="display: none;" type="checkbox" value="sdv.mp"><label style="margin-bottom: 2px; margin-right: 5px;" for="sdv.mp"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Microbiologie et Parasitologie</span>
                                            <ul>
                                        ...
                                        <li style="display : list-item;"><input id="sdv.neu" style="display: none;" type="checkbox" value="sdv.neu"><label style="margin-bottom: 2px; margin-right: 5px;" for="sdv.neu"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Neurosciences [q-bio.NC]</span>
                                            <ul>
                                        ...
                                        <li style="display : list-item;"><input id="sdv.sa" style="display: none;" type="checkbox" value="sdv.sa"><label style="margin-bottom: 2px; margin-right: 5px;" for="sdv.sa"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Sciences agricoles</span>
                                            <ul>    
                                        ...
                                        <li style="display : list-item;"><input id="sdv.sp" style="display: none;" type="checkbox" value="sdv.sp"><label style="margin-bottom: 2px; margin-right: 5px;" for="sdv.sp"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Sciences pharmaceutiques</span>
                                            <ul>    
                                        ...
                                        <li style="display : list-item;"><input id="sdv.tox" style="display: none;" type="checkbox" value="sdv.tox"><label style="margin-bottom: 2px; margin-right: 5px;" for="sdv.tox"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Toxicologie</span>
                                            <ul>    
                                ...
                                <li style="display : list-item;"><input id="shs" style="display: none;" type="checkbox" value="shs"><label style="margin-bottom: 2px; margin-right: 5px;" for="shs"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Sciences de l'Homme et Société</span>
                                    <ul>
                                ...
                                <li style="display : list-item;"><input id="spi" style="display: none;" type="checkbox" value="spi"><label style="margin-bottom: 2px; margin-right: 5px;" for="spi"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Sciences de l'ingénieur [physics]</span>
                                    <ul>
                                        ...
                                        <li style="display : list-item;"><input id="spi.meca" style="display: none;" type="checkbox" value="spi.meca"><label style="margin-bottom: 2px; margin-right: 5px;" for="spi.meca"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Mécanique [physics.med-ph]</span>
                                            <ul>
                                ...
                                <li style="display : list-item;"><input id="stat" style="display: none;" type="checkbox" value="stat"><label style="margin-bottom: 2px; margin-right: 5px;" for="stat"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Statistiques [stat]</span>
                                    <ul>
                                ...
                                <li style="display : list-item;"><input id="qfin" style="display: none;" type="checkbox" value="qfin"><label style="margin-bottom: 2px; margin-right: 5px;" for="qfin"><span class="caret" style="margin-top: 0px;"></span><i class="glyphicon glyphicon-folder-close"></i></label><span class="libelle click" style="cursor: pointer;">Économie et finance quantitative [q-fin]</span>
                                    <ul>    
